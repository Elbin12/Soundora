...
function SuggestedArtists({ artists }) {
  ...
  return (
    <div className='mt-16 fixed bg-gray-950/80 z-10 border-2 w-3/5 rounded-md overflow-hidden shadow-sm'>
        ...
        { artists?.length > 0?
            artists?.map((artist, index) => (
                <div 
                    ...
                    onClick={()=>{navigate(`artist/${artist.name}/${artist.spotify_id}`)}}
                >
